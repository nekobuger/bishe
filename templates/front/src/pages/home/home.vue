...
<div class="home-preview" :style='{"width":"100%","margin":"10px auto","alignItems":"flex-start","flexWrap":"wrap","display":"flex"}'>
	...
	<!-- 新闻资讯 -->
	<div id="animate_newsnews" class="news animate__animated" :style='{"padding":"30px 10%  50px","margin":"0 auto","background":"url(http://codegen.caihongy.cn/20231126/63b650a0aa95438c8d59ce436224ccf2.png)","width":"100%","backgroundSize":"cover","backgroundPosition":"center center","position":"relative","backgroundRepeat":"no-repeat","order":"6"}'>
		...
		<div class="title" :style='{"width":"200px","margin":"20px 0 20px","lineHeight":"1","textAlign":"left","background":"none"}'>
			<span :style='{"color":"#71509E","fontSize":"32px"}'>公告信息</span>
		</div>
		...
		<div class="list list15 index-pv1" :style='{"width":"100%","padding":"10px 0","background":"none","height":"auto"}'>
			<div class="tab" :style='{"top":"20px","left":"10%","display":"none","width":"80%","position":"absolute","justifyContent":"space-between","height":"auto"}'>
		  ...
		  <div v-if="newsList.length" class="content" :style='{"width":"100%","justifyContent":"space-between","display":"flex","height":"450px"}'>
		    <div @click="toDetail('newsDetail', newsList[0])" class="left list-item animation-box" :style='{"cursor":"pointer","padding":"25px 20px","borderColor":"#efefef #efefef red #efefef","margin":"0","flexWrap":"wrap","background":"#fff","borderWidth":"0","display":"flex","width":"380px","borderStyle":"solid","height":"auto"}'>
		...
		<div @click="moreBtn('news')" :style='{"border":"0","margin":"0 auto","top":"60px","textAlign":"center","background":"none","display":"block","width":"auto","lineHeight":"1","position":"absolute","right":"10%"}'>
...
<div id="animate_recommendkechengxinxi" class="recommend animate__animated" :style='{"padding":"30px 10%","margin":"0 0 0","background":"url(http://codegen.caihongy.cn/20231125/8a4a2d41e5c9470aab1a79679b276e9d.png)","width":"100%","backgroundSize":"cover","backgroundPosition":"center center","position":"relative","backgroundRepeat":"no-repeat","order":"1"}'>
    ...
    <div class="title" :style='{"width":"200px","margin":"100px 0 20px","lineHeight":"1","textAlign":"left","background":"none"}'>
		<span :style='{"color":"#71509E","fontSize":"32px"}'>课程信息推荐</span>
	</div>
	...
	<div v-if="kechengxinxiRecommend.length" class="list list12 index-pv1 list12kechengxinxi" :style='{"width":"100%","padding":"0","background":"none","height":"auto"}'>
	  <div class="tab" :style='{"margin":"0 0 20px","top":"20px","left":"10%","display":"flex","width":"80%","position":"absolute","justifyContent":"space-between","height":"auto"}'>
		...
		<div v-if="index < 6" @click="recommendIndexClick12(index + 1, 'kechengxinxi')" class="item" :class="index + 1 == recommendIndex12kechengxinxi ? 'active' : ''">
			<img v-if="item.image" :style='{"width":"50px","margin":"0 0 0 5px","objectFit":"cover","display":"block","height":"50px","order":"2"}' :src="baseUrl + (item.image?item.image.split(',')[0]:'')">
	  ...
	  <div class="list" :style='{"overflow":"hidden","flexWrap":"wrap","background":"none","justifyContent":"space-between","display":"flex","height":"auto"}'>
	    <div :style='{"cursor":"pointer","width":"32%","margin":"0 0 20px","position":"relative","height":"auto"}' class="item list-item animation-box" v-for="item,index in kechengxinxiRecommend" :key="index" @click="toDetail('kechengxinxiDetail', item)">
			<img :name="item.id" :style='{"border":"1px solid #d8cbeb","width":"100%","objectFit":"contain","background":"rgba(255,255,255,.3)","display":"block","height":"248px"}' v-if="preHttp(item.kechengfengmian)" :src="item.kechengfengmian.split(',')[0]" alt="" />
			<img :name="item.id" :style='{"border":"1px solid #d8cbeb","width":"100%","objectFit":"contain","background":"rgba(255,255,255,.3)","display":"block","height":"248px"}' v-else :src="baseUrl + (item.kechengfengmian?item.kechengfengmian.split(',')[0]:'')" alt="" />
			<div class="line1" :style='{"padding":"0 10px","overflow":"hidden","whiteSpace":"nowrap","color":"#333","width":"100%","lineHeight":"32px","fontSize":"16px","textOverflow":"ellipsis"}'>课程名称:{{item.kechengmingcheng}}</div>
			<div class="line1" :style='{"padding":"0 10px","overflow":"hidden","whiteSpace":"nowrap","color":"#333","width":"100%","lineHeight":"32px","fontSize":"16px","textOverflow":"ellipsis"}'>{{item.kechengleixing}}</div>
	    </div>
	  </div>
	</div>
	...
	<div @click="moreBtn('kechengxinxi')" :style='{"border":"0","margin":"10px auto","top":"120px","textAlign":"center","background":"none","display":"block","width":"auto","lineHeight":"32px","position":"absolute","right":"10%"}'>
		<span :style='{"color":"#858585","fontSize":"15px"}'>查看更多</span>
...
<!-- 商品推荐 -->
<div id="animate_recommendziliaoxinxi" class="recommend animate__animated" :style='{"padding":"30px 10%","margin":"0 0 0","background":"url(http://codegen.caihongy.cn/20231125/8a4a2d41e5c9470aab1a79679b276e9d.png)","width":"100%","backgroundSize":"cover","backgroundPosition":"center center","position":"relative","backgroundRepeat":"no-repeat","order":"1"}'>
	<div v-if="false" class="idea recommendIdea" :style='{"padding":"20px","flexWrap":"wrap","background":"#efefef","justifyContent":"space-between","display":"flex"}'>
		<div class="box1" :style='{"width":"20%","background":"#fff","height":"80px"}'></div>
		<div class="box2" :style='{"width":"20%","background":"#fff","height":"80px"}'></div>
		<div class="box3" :style='{"width":"20%","background":"#fff","height":"80px"}'></div>
    ...
    <div class="title" :style='{"width":"200px","margin":"100px 0 20px","lineHeight":"1","textAlign":"left","background":"none"}'>
		<span :style='{"color":"#71509E","fontSize":"32px"}'>资料信息推荐</span>
	</div>
	...
	<div v-if="ziliaoxinxiRecommend.length" class="list list12 index-pv1 list12ziliaoxinxi" :style='{"width":"100%","padding":"0","background":"none","height":"auto"}'>
	  <div class="tab" :style='{"margin":"0 0 20px","top":"20px","left":"10%","display":"flex","width":"80%","position":"absolute","justifyContent":"space-between","height":"auto"}'>
	    <template v-for="item,index in recommendList12ziliaoxinxi">
		<div v-if="index < 6" @click="recommendIndexClick12(index + 1, 'ziliaoxinxi')" class="item" :class="index + 1 == recommendIndex12ziliaoxinxi ? 'active' : ''">
			<img v-if="item.image" :style='{"width":"50px","margin":"0 0 0 5px","objectFit":"cover","display":"block","height":"50px","order":"2"}' :src="baseUrl + (item.image?item.image.split(',')[0]:'')">
			<div :style='{"color":"inherit","fontSize":"14px"}'>{{item[recommendColumn12ziliaoxinxi]}}</div>
		</div>
		</template>
		<div class="more" @click="moreBtn('ziliaoxinxi')">
		  <div :style='{"color":"inherit","fontSize":"14px"}'>更多</div>
		  <span class="icon iconfont icon-jiantou25" :style='{"color":"inherit","margin":"0 0 0 2px","fontSize":"14px"}'></span>
		</div>
	  </div>
	  <div class="list" :style='{"overflow":"hidden","flexWrap":"wrap","background":"none","justifyContent":"space-between","display":"flex","height":"auto"}'>
	    <div :style='{"cursor":"pointer","width":"32%","margin":"0 0 20px","position":"relative","height":"auto"}' class="item list-item animation-box" v-for="item,index in ziliaoxinxiRecommend" :key="index" @click="toDetail('ziliaoxinxiDetail', item)">
			<img :name="item.id" :style='{"border":"1px solid #d8cbeb","width":"100%","objectFit":"contain","background":"rgba(255,255,255,.3)","display":"block","height":"248px"}' v-if="preHttp(item.fengmian)" :src="item.fengmian.split(',')[0]" alt="" />
			<img :name="item.id" :style='{"border":"1px solid #d8cbeb","width":"100%","objectFit":"contain","background":"rgba(255,255,255,.3)","display":"block","height":"248px"}' v-else :src="baseUrl + (item.fengmian?item.fengmian.split(',')[0]:'')" alt="" />
			<div class="line1" :style='{"padding":"0 10px","overflow":"hidden","whiteSpace":"nowrap","color":"#333","width":"100%","lineHeight":"32px","fontSize":"16px","textOverflow":"ellipsis"}'>{{item.ziliaomingcheng}}</div>
			<div class="line1" :style='{"padding":"0 10px","overflow":"hidden","whiteSpace":"nowrap","color":"#333","width":"100%","lineHeight":"32px","fontSize":"16px","textOverflow":"ellipsis"}'>{{item.ziliaoleixing}}</div>
	    </div>
	  </div>
	</div>
	...
	<div @click="moreBtn('ziliaoxinxi')" :style='{"border":"0","margin":"10px auto","top":"120px","textAlign":"center","background":"none","display":"block","width":"auto","lineHeight":"32px","position":"absolute","right":"10%"}'>
		<span :style='{"color":"#858585","fontSize":"15px"}'>查看更多</span>
		<i :style='{"color":"#858585","fontSize":"14px"}' class="icon iconfont icon-gengduo1"></i>
	</div>
  ...
  export default {
    ...
    data() {
      return {
		...
		recommendIndex12ziliaoxinxi: 0,
		recommendList12ziliaoxinxi: [],
		recommendColumn12ziliaoxinxi: '',
    ...
    methods: {
		...
		ziliaoxinxiRecommendCate(){
			this.$http.get('ziliaoleixing/list',{}).then(res => {
			  if (res.data.code == 0) {
				this.recommendList12ziliaoxinxi = res.data.data.list
			  }
			});
			this.recommendColumn12ziliaoxinxi = 'ziliaoleixing'
		},
		...
		handleScroll() {
			let arr = [
				...
				{id:'animate_recommendziliaoxinxi',css:'animate__'},
      ...
      getSystemIntroduction() {
		...
		getList() {
          ...
          autoSortUrl = "ziliaoxinxi/autoSort";
			data = {
				page: 1,
				limit: 6,
			}
			if(this.recommendIndex12ziliaoxinxi != 0){
				data.ziliaoleixing = this.recommendList12ziliaoxinxi[this.recommendIndex12ziliaoxinxi - 1].ziliaoleixing
			}
			this.$http.get(autoSortUrl, {params: data}).then(res => {
				if (res.data.code == 0) {
					this.ziliaoxinxiRecommend = res.data.data.list;
	...
	.home-preview {
        ...
        .list5 .swiper-button-next {
			...
			.index-pv1 .animation-box:hover {
				transform: rotate(0deg) scale(0.98) skew(0deg, 0deg) translate3d(0px, 6px, 0px);
		...
		.news {
			...
			.index-pv1 .animation-box:hover {
				transform: rotate(0deg) scale(1.01) skew(0deg, 0deg) translate3d(0px, 2px, 0px);
				-webkit-perspective: 1000px;
				perspective: 1000px;
				transition: 0.3s;
				z-index: 1;
