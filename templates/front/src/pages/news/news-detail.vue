<template>
	...
	<div :style='{"width":"100%"}'>
		<div :style='{"width":"100%","background":"linear-gradient(180deg, #A293B6 0%, rgba(241,231,255,0) 100%)","clipPath":"polygon(30px 00%, 0% 100%, 100% 100%, calc(100% - 30px) 0%)","height":"auto"}'>
			<div :style='{"margin":"10px 0","color":"#000","textAlign":"center","background":"none","fontSize":"20px","lineHeight":"54px","fontWeight":"bold"}'>公告信息</div>
		</div>
		...
		<!-- option -->
		<div :style='{"width":"100%","padding":"0 20px","margin":"20px 0","justifyContent":"flex-end","display":"flex","height":"auto"}'>
