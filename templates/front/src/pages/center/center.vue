...
<div class="center-preview" :style='{"width":"80%","margin":"0 auto","position":"relative","flexWrap":"wrap","background":"#FCFAFF","display":"flex"}'>
	...
	<div class="info" :style='{"padding":"40px 40px 40px 140px","boxShadow":"none","margin":"20px auto","borderRadius":"0","background":"none","width":"35%","position":"relative","height":"auto"}'>
		...
		<div :style='{"borderColor":"#efefef","top":"40px","left":"40px","borderWidth":"0","width":"100px","fontSize":0,"position":"absolute","borderStyle":"solid","height":"100px"}' v-if="userTableName=='jiaoshi'">
		...
		<div :style='{"borderColor":"#efefef","top":"40px","left":"40px","borderWidth":"0","width":"100px","fontSize":0,"position":"absolute","borderStyle":"solid","height":"100px"}' v-if="userTableName=='xuesheng'">
			<el-image :style='{"margin":"10px auto","borderColor":"#efefef","objectFit":"cover","borderRadius":"10px","borderWidth":"0 0 1px 0","display":"block","width":"100%","borderStyle":"solid","height":"100%"}' :src="sessionForm.touxiang?baseUrl + sessionForm.touxiang:require('@/assets/avator.png')" fit="cover"></el-image>
		</div>
		<div :style='{"padding":"0 20px","borderColor":"#efefef","borderWidth":"0","display":"flex","width":"100%","lineHeight":"40px","borderStyle":"solid","height":"auto"}' v-if="userTableName=='jiaoshi'">
			...
			<div :style='{"fontSize":"20px","color":"#000","textAlign":"left","flex":1,"fontWeight":"bold"}'>{{sessionForm.jiaoshigonghao}}</div>
		</div>
		<div :style='{"padding":"0 20px","borderColor":"#efefef","borderWidth":"0","display":"flex","width":"100%","lineHeight":"1","borderStyle":"solid","height":"auto"}' v-if="userTableName=='jiaoshi'">
			<span class="icon iconfont icon-shouye-zhihui" :style='{"padding":"0 5px","fontSize":"14px","color":"#333","display":"none"}'></span>
			<div :style='{"color":"#000","fontSize":"14px","display":"none"}'>教师姓名</div>
			<div :style='{"fontSize":"16px","color":"#000","textAlign":"left","flex":1}'>{{sessionForm.jiaoshixingming}}</div>
		</div>
		<div :style='{"padding":"80px 20px 0","borderColor":"#efefef","flexWrap":"wrap","borderWidth":"0","display":"flex","width":"100%","lineHeight":"1.5","borderStyle":"solid","height":"auto"}' v-if="userTableName=='jiaoshi'">
			<span class="icon iconfont icon-shouye-zhihui" :style='{"padding":"0 5px","fontSize":"14px","color":"#333","display":"none"}'></span>
		...
		<div :style='{"padding":"80px 20px 0","borderColor":"#efefef","flexWrap":"wrap","borderWidth":"0","display":"flex","width":"100%","lineHeight":"1.5","borderStyle":"solid","height":"auto"}' v-if="userTableName=='jiaoshi'">
			<span class="icon iconfont icon-shouye-zhihui" :style='{"padding":"0 5px","fontSize":"14px","color":"#333","display":"none"}'></span>
			<div :style='{"color":"#000","width":"100%","fontSize":"16px"}'>联系电话</div>
			<div :style='{"width":"100%","fontSize":"16px","color":"#000","textAlign":"left","flex":1}'>{{sessionForm.lianxidianhua}}</div>
		</div>
		<div :style='{"padding":"0 20px","borderColor":"#efefef","borderWidth":"0","display":"flex","width":"100%","lineHeight":"40px","borderStyle":"solid","height":"auto"}' v-if="userTableName=='xuesheng'">
			<span class="icon iconfont icon-shouye-zhihui" :style='{"padding":"0 5px","fontSize":"14px","color":"#333","display":"none"}'></span>
			<div :style='{"color":"#333","fontSize":"14px","display":"none"}'>学号</div>
			<div :style='{"fontSize":"20px","color":"#000","textAlign":"left","flex":1,"fontWeight":"bold"}'>{{sessionForm.xuehao}}</div>
		</div>
		<div :style='{"padding":"0 20px","borderColor":"#efefef","borderWidth":"0","display":"flex","width":"100%","lineHeight":"1","borderStyle":"solid","height":"auto"}' v-if="userTableName=='xuesheng'">
			<span class="icon iconfont icon-shouye-zhihui" :style='{"padding":"0 5px","fontSize":"14px","color":"#333","display":"none"}'></span>
			<div :style='{"color":"#000","fontSize":"14px","display":"none"}'>学生姓名</div>
			<div :style='{"fontSize":"16px","color":"#000","textAlign":"left","flex":1}'>{{sessionForm.xueshengxingming}}</div>
		</div>
		<div :style='{"padding":"80px 20px 0","borderColor":"#efefef","flexWrap":"wrap","borderWidth":"0","display":"flex","width":"100%","lineHeight":"1.5","borderStyle":"solid","height":"auto"}' v-if="userTableName=='xuesheng'">
			<span class="icon iconfont icon-shouye-zhihui" :style='{"padding":"0 5px","fontSize":"14px","color":"#333","display":"none"}'></span>
			<div :style='{"color":"#000","width":"100%","fontSize":"16px"}'>性别</div>
			<div :style='{"width":"100%","fontSize":"16px","color":"#000","textAlign":"left"}'>{{sessionForm.xingbie}}</div>
		</div>
		<div :style='{"padding":"80px 20px 0","borderColor":"#efefef","flexWrap":"wrap","borderWidth":"0","display":"flex","width":"100%","lineHeight":"1.5","borderStyle":"solid","height":"auto"}' v-if="userTableName=='xuesheng'">
			<span class="icon iconfont icon-shouye-zhihui" :style='{"padding":"0 5px","fontSize":"14px","color":"#333","display":"none"}'></span>
			<div :style='{"color":"#000","width":"100%","fontSize":"16px"}'>班级</div>
			<div :style='{"width":"100%","fontSize":"16px","color":"#000","textAlign":"left","flex":1}'>{{sessionForm.banji}}</div>
		</div>
		<div :style='{"padding":"80px 20px 0","borderColor":"#efefef","flexWrap":"wrap","borderWidth":"0","display":"flex","width":"100%","lineHeight":"1.5","borderStyle":"solid","height":"auto"}' v-if="userTableName=='xuesheng'">
			<span class="icon iconfont icon-shouye-zhihui" :style='{"padding":"0 5px","fontSize":"14px","color":"#333","display":"none"}'></span>
			<div :style='{"color":"#000","width":"100%","fontSize":"16px"}'>联系电话</div>
			<div :style='{"width":"100%","fontSize":"16px","color":"#000","textAlign":"left"}'>{{sessionForm.lianxidianhua}}</div>
		</div>
    ...
    <el-tabs tab-position="left" :style='{"width":"65%","flexWrap":"wrap","background":"none","justifyContent":"center","display":"flex"}' @tab-click="handleClick">
      <el-tab-pane label="个人中心">
        <el-form class="center-preview-pv" ref="sessionForm" :model="sessionForm" :rules="rules" label-width="80px">
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' v-if="userTableName=='jiaoshi'" label="头像" prop="touxiang">
			<file-upload
			tip="点击上传头像"
			action="file/upload"
			:limit="1"
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' v-if="userTableName=='xuesheng'" label="联系电话" prop="lianxidianhua">
            <el-input v-model="sessionForm.lianxidianhua" placeholder="联系电话" ></el-input>
          </el-form-item>
