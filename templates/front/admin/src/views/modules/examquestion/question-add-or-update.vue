<template>
  <div :style='{"color":"#666","padding":"0px 30px 30px","fontSize":"14px"}'>
    <el-form
      ...
      label-width="150px"
    >
      <el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' label="选择数学试卷" prop="paperid">
        <el-select @change="onPaperChange" v-model="ruleForm.paperid" placeholder="选择数学试卷">
          <el-option
...
export default {
  data() {
    ...
    return {
      ...
      rules: {
        paperid: [{ required: true, message: "请选择数学试卷", trigger: "blur" }],
        questionname: [
